...
<div
    ...
    x-show="modalOpen"
    @keydown.escape.window="if (modalOpen) { modalOpen = false; $dispatch('cerrarModalOrdenServicio') }"
>

    <div class="relative z-10" aria-labelledby="dialog-title" role="dialog" aria-modal="true">
        <!-- Background backdrop -->
        <div class="fixed inset-0 bg-gray-500/75 transition-opacity" aria-hidden="true" @click="if (modalOpen) { modalOpen = false; $dispatch('cerrarModalOrdenServicio') }"></div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-gray-200">
                        <div class="sm:flex sm:items-start">
                            ...
                            <button
                                ...
                                @click="if (modalOpen) { modalOpen = false; $dispatch('cerrarModalOrdenServicio') }"
